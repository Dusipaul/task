  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="dropdown">
   	<a href="./" class="brand-link">
        ...
        <h3 class="text-center p-0 m-0"><b>OFFICER</b></h3>
        <?php else: ?>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <?php if($_SESSION['login_type'] != 1 || 2): ?>
              <li class="nav-item">
                <a href="./index.php?page=new_loan_id" class="nav-link nav-new_project tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Request Loan with ID</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=new_loan_tin" class="nav-link nav-new_project tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Request Loan with ID</p>
                </a>
              </li>
